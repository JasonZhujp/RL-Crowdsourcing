...
def get_config():
    ...
    parser.add_argument("--exp_config", type=str, default="configs/sac_w_config.txt", help="The path where the config file saves.")
...
def train(args, e_tensordata):
    ...
    agent = SACAgent(**args['SACAgent_param'])
    ...
    for epoch in range(args['epoch']):
        ...
        for partition_id in partition_order:
            ...
            for batch_idx, data in enumerate(dataloader):
                ...
                if batch_cnt % args['SACAgent_param']['a_update_frequency'] == 0:
...
if __name__ == "__main__":
    ...
    # nohup python -u train_sac.py --exp_config configs/sac_w_config.txt> logs/sac_w_0701_xxxx_s1111.log 2>&1 &
